...
namespace evidencia_desarrollo
{
	class Program
	{
		...
		static void GuardarArchivo()
		{
			...
			TextWriter guardararchivo = new StreamWriter("C:/Users/PC/source/repos/.net/listaestudiantes.xml");
		...
		static void CargarXml()
		{
			...
			if (File.Exists("C:/Users/PC/source/repos/.net/listaestudiantes.xml"))
			{
				XmlSerializer codificador = new XmlSerializer(typeof(List<estudiante>));
				FileStream cargarXml = File.OpenRead("C:/Users/PC/source/repos/.net/listaestudiantes.xml");
